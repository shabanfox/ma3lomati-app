...
st.markdown("<p style='text-align:center; color:#444; margin-top:50px;'>MA3LOMATI PRO © 2026 | النسخة الاحترافية</p>", unsafe_allow_html=True)        st.markdown('<div class="tool-box"><h3>\U0001F4B8</h3><h4>العمولة</h4></div>', unsafe_allow_html=True)
