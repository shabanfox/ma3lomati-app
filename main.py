...
# 4. التنسيق الجمالي (CSS) - الألوان الاحترافية (Midnight & Gold)
st.markdown(f"""
    <style>
    ...
    div.stButton > button:hover {{ border-color: #f59e0b !important; color: #f59e0b !important; }}

    /* كروت المشاريع والمطورين (الأزرار الخاصة) */
