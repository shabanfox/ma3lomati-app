...
if not st.session_state.logged_in:
    # صفحة تسجيل الدخول (لحماية المحتوى)
    ...
    # --- الموقع الرئيسي (رجع كما كان تماماً وبدون كلمة خروج) ---
    st.markdown("""
    ...
    st.markdown("<h3 style='margin: 30px 0 20px 0; color:#1e293b;'>أحدث المشاريع العقارية</h3>", unsafe_allow_html=True)

    # الكارت العريض الأصلي
    st.markdown("""
        <div class="project-card">
            ...
            <div class="card-body">
                <div>
                    ...
                    <div style="font-weight: 700; font-size: 1.15rem; color: #1e293b;">كمبوند ايفوري جولي - الشيخ زايد</div>
