انا عايز الكود import streamlit as st
import pandas as pd
...
st.markdown("<p style='text-align:center; color:#444; margin-top:50px;'>MA3LOMATI PRO © 2026</p>", unsafe_allow_html=True) ب هنضيف الشكل بتاع تسجيل الدخول
