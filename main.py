...
# 3. الـ CSS المعتمد (النسخة الخام بدون أخطاء)
st.markdown("""
...
if not st.session_state.logged_in:
    ...
    with col:
        ...
        user = st.text_input("اسم المستخدم", placeholder="ادخل الاسم")
        pwd = st.text_input("كلمة المرور", type="password", placeholder="ادخل الرقم السري")
    ...
    # 5. المنصة الرئيسية (تظهر فقط بعد الدخول)
    st.markdown("""
        ...
        <div style="padding: 0 8%; margin-top:25px;">
            <h3 style="color:#003366; margin-bottom:20px;">أحدث المشاريع</h3>
            <div class="project-card">
                ...
                <div class="card-body">
                    ...
                    <div style="text-align: left;"><button class="btn-details">عرض التفاصيل</button></div>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)
