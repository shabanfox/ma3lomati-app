...
# إضافة المكتبة المطلوبة للتحديث التلقائي
...
# تفعيل التحديث التلقائي للساعة كل ثانية فقط في حالة تسجيل الدخول بنجاح
# هذا يمنع إعادة تحميل الصفحة (Refresh) أثناء محاولة المستخدم كتابة بياناته في صفحة الدخول
...
# 8. شريط المعلومات العلوي (تحديث حي للساعة)
c_top1, c_top2 = st.columns([0.7, 0.3])
with c_top1:
    st.markdown(f'<div class="ticker-wrap"><div class="ticker">🔥 {news_text}</div></div>', unsafe_allow_html=True)
with c_top2:
    # هنا تم تحديث الساعة لتشمل الثواني وتتغير تلقائياً
...
# --- 14. حقيبة البروكر ---
    ...
    with r1_c3:
        st.markdown("<div class='tool-card'><h3>
