...
# 3. إدارة الحالة ودعم الريفريش (التعديل المطلوب)
        ...
        with c2:
            ...
            if st.button("دخول للمنصة 🚀"):
                ...
                if user_name:
                    ...
                    st.query_params["u"] = user_name # حفظ الجلسة في الرابط
                    st.rerun()
...
# 8. شريط المعلومات والساعة الذكية (التعديل المطلوب)
...
# --- صفحات المحتوى ---
    ...
    st.markdown("<div class='smart-box'>🤖 مساعد الربط الذكي</div>", unsafe_allow_html=True)
