...
# 3. التصميم (CSS) - تركيز على الهيدر الموحد
st.markdown("""
    <style>
    ...
    .header-nav {
        ...
        padding: 0 8%;
        display: flex;
        justify-content: space-between; /* اللوجو يمين والروابط يسار */
        align-items: center;
    ...
    /* تنسيق زر الخروج ليكون كلمة في سطر واحد */
    .stButton > button {
...
if not st.session_state.logged_in:
    ...
    # --- الموقع الرئيسي (الهيدر في سطر واحد) ---
    
    # بناء الهيدر يدوياً لضمان السطر الواحد
    st.markdown(f"""
    ...
    # وضع زر "خروج" بجانب الرئيسية برمجياً
    if st.button("خروج"):
        logout_action()
    ...
    st.markdown("<h3 style='margin: 30px 0 15px 0;'>أحدث المشاريع</h3>", unsafe_allow_html=True)
        ...
        <div class="project-card">
            ...
            <div class="card-body">
                ...
                <div style="text-align: left;">
                    <button style="background:white; border:1px solid #0056b3; color:#0056b3; padding:5px 15px; border-radius:5px; font-weight:700;">التفاصيل</button>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)
